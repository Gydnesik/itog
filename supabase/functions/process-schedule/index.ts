...
2) Затем найди строки дней и номеров уроков.
3) Потом прочитай каждую клетку на пересечении класса и строки.
4) После первичного чтения мысленно пройди таблицу второй раз слева направо и сверху вниз и проверь, что ни один класс/урок не потерян.
